...
var bob1, bob2, bob3, bob4, bob4, bob5;
var roof;
...
function setup() {
	...
	bob1 = new Bob(170,500,90);
	bob2 = new Bob(260,500,90);
	bob3 = new Bob(350,500,90);
	bob4 = new Bob(440,500,90);
	bob5 = new Bob(530,500,90);
  roof = new Roof(350, 90, 500, 30);
